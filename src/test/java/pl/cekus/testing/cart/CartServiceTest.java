...
import pl.cekus.testing.order.OrderStatus;
...
class CartServiceTest {
    ...
    @Test
    void processCardShouldSendToPrepare() {
        //given
    ...
    @Test
    void processCardShouldNotSendToPrepare() {
        //given
        Order order = new Order();
        Cart cart = new Cart();
        cart.addOrderToCart(order);
    ...
    @Test
    void processCardShouldNotSendToPrepareWithArgumentMatchers() {
        //given
        Order order = new Order();
        Cart cart = new Cart();
        cart.addOrderToCart(order);
    ...
    @Test
    void processCardShouldSendToPrepareWithLambdas() {
        //given
        Order order = new Order();
        Cart cart = new Cart();
        cart.addOrderToCart(order);
    ...
    @Test
    void processCardShouldSendToPrepareWithArgumentCaptor() {
        //given
        Order order = new Order();
        Cart cart = new Cart();
        cart.addOrderToCart(order);
