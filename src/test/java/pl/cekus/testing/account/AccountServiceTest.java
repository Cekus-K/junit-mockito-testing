...
class AccountServiceTest {
    ...
    void getAccountsByName() {
        ...
        AccountRepository accountRepository = mock(AccountRepository.class);
        AccountService accountService = new AccountService(accountRepository);
        given(accountRepository.getByName("kamil")).willReturn(Collections.singletonList("cekus"));

        //when
        List<String> accountNames = accountService.findByName("kamil");

        //then
        assertThat(accountNames, contains("cekus"));
    }
